...
const PREDATORS: Predator[] = [
  ...
  },
  {
    ...
    overlays: [
      { label: "⚠  FOOD CHAIN IMBALANCE", text: "Bullfrogs consume large amounts of insects and invertebrates.", top: "5%", left: "1%" },
      { label: "⚠  CHICK VULNERABLE", text: "Young coots near water face direct predation risk.", top: "5%", left: "50%", transform: "translateX(-50%)" },
    ],
    ecoImpact: [
