...
const PREDATORS: Predator[] = [
  ...
  },
  {
    ...
    overlays: [
      ...
      { label: "⚠  CHICK VULNERABLE", text: "Young coots near water face direct predation risk.", top: "58%", left: "50%" },
    ],
    ecoImpact: [
...
export function Predators() {
  ...
  return (
    <div style={{
      ...
      {/* ── 3. BOTTOM CAROUSEL — SEE THE DIFFERENCE ───────────────────── */}
      <div style={{
        flexShrink: 0, background: "rgba(0,0,0,0.7)",
        borderTop: "1px solid rgba(255,255,255,0.07)",
        padding: "8px 16px",
      }}>
        <p style={{ fontSize: 9, letterSpacing: "0.2em", color: "rgba(255,255,255,0.35)", marginBottom: 7, textAlign: "center" }}>
          SEE THE DIFFERENCE
        </p>
        <div style={{ display: "flex", gap: 8, justifyContent: "center" }}>
          {PREDATORS.map(pred => {
            ...
            return (
              ...
              >
                <div style={{
                  width: 88, height: 52, borderRadius: 6, overflow: "hidden",
